...
def test_simulation():
    expectWl = [438., 470., 456., 446., 445., 421., 371., 377., 364., 339., 285.,
           297., 257., 268., 228., 223., 176., 169., 161., 159.]
    ...
    class MySim(Prompt):
        ...
        def makeWorld(self):
            ...
            sample = Volume('sample', Tube(rmin=8, rmax=r, z=r, startphi=np.deg2rad(0), deltaphi=np.deg2rad(360)), 'Al_sg225.ncmat')
