...
def test_simulation():
    class MySim(Prompt):
        ...
        def makeWorld(self):
            ...
            filter_mat = "Al2O3_sg167_Corundum.ncmat;mos=2deg;dir1=@crys_hkl:0,0,6@lab:0,0,1;dir2=@crys_hkl:3,0,0@lab:1,0,0"
            filter = Volume("det1", Tube(0, 25, 50), matCfg=Material(filter_mat))
